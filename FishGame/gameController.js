...
var myGameArea = {
	...
	this.context = this.canvas.getContext("2d");
        ...
        insertPoint.insertBefore(this.canvas, insertPoint.childNodes[2]);
        //for 60 fps
...
function showSubmitScore() {
	var scoreDiv = document.getElementById("scoreSubmission");
	scoreDiv.style.display = "block";
}

function hideSubmitScore() {
	var scoreDiv = document.getElementById("scoreSubmission");
	scoreDiv.style.display = "none";
}

function displaySubmissionText(text, color) {
	var element = document.getElementById("submissionText");
	element.style.display = "block";
	element.innerHTML = text;
	element.style.color = color;
}

function hideSubmissionText() {
	var element = document.getElementById("submissionText");
...
function submitScore()
{
	...
	var playerScore = gameControl.score;
	...
	xhr.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			if (response.code === 200) {
				displaySubmissionText("Score submitted!", "green");
				document.getElementById("scoreSubmission").style.display = "none";
				document.getElementById("nameInput").value = '';
			}
			else {
				document.getElementById("scoreSubmission").style.display = "block";
				displaySubmissionText(response.message, "red");
			}
		}
	}
	xhr.open("POST", "https://nigelhaney.me/api/game", true);
	...
	displaySubmissionText("Submitting...", "black");
}
